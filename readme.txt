Control the position of the robot along the x-axis
In the relevant code, the movement of the robot in a direct path is controlled by implementing the PID class.This is impelimented in PID.py .
